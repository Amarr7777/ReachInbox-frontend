...
function LoginCard() {
  ...
  const handleLogin = () => {
    ...
    const redirectUri = 'https://reach-inbox-frontend-mgp5sepu9-amar-g-naths-projects.vercel.app/onebox'; // Your frontend URL where Google will redirect after login
